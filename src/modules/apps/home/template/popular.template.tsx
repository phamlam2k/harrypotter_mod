...
import usePopularController from '../controllers/popular.controller';

const MostPopularPage = () => {
    const stories = usePopularController();
    ...
    return (
        <Box sx={{ backgroundColor: '#f4f6f8', minHeight: '100vh', padding: '20px' }}>
            ...
            <Typography variant="h5" component="div" sx={{ margin: '20px 0', textAlign: 'center', fontWeight: 'bold' }}>
                The Library's Most Popular Handwritten Story
            </Typography>
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={{ fontWeight: 'bold', color: '#3f51b5' }}>Upvotes</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {stories.map((book, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>{book.upvotes}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
